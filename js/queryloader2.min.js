...
! function e(t, n, i) {
    ...
    1: [function (e, t, n) {
        ...
        var i = e("./ImageLoaded.js"),
            r = {
                create: function () {
                    this.element = document.createElement("imageback"), this.element.setAttribute("src", this.src)
                },
                preload: function (e) {
    ...
    2: [function (e, t, n) {
        ...
        function i(e, t) {
            ...
            var o;
            return e.nodeName ? "imageback" !== e.nodeName.toLowerCase() ? t(new Error("Element supplied is not an image")) : e.src && e.complete && void 0 !== e.naturalWidth ? t(null, !0) : (n(e, "load", !0, i), n(e, "error", !0, i), void((e.readyState || e.complete) && (o = e.src, e.src = r, e.src = o))) : t(new Error("First argument must be an image element"))
        }
